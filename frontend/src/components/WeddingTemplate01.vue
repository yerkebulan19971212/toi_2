...
<template>
  <div class="invite-wrap">
    ...
    <section class="section envelope-section" :class="{ open: envelopeOpen }">
      <div class="envelope-bg">
        <div class="env-flap top-flap"></div>
        <div class="env-body">
          ...
          <p class="env-text">
            Вы не просто так получили это<br>
            приглашение! В особенный<br>
            для нас день мы очень хотим,<br>
            чтобы вы были рядом!
          </p>
        </div>
      </div>
    ...
    <section class="section guests-section">
      ...
      <p class="body-text">
        Мы приглашаем вас разделить с нами<br>
        радостный день, в который мы станем<br>
        семьёй!
      </p>
      <p class="body-text mt-12">
        В этот волшебный день мы скажем<br>
        друг другу «Да» и соединим наши<br>
        сердца и судьбы в окружении самых<br>
        ...
        <div class="calendar-grid">
          ...
          <div
            ...
            :class="{
              ...
              'cal-wedding': cell.isWedding,
            }"
          >
            <span v-if="cell.isWedding">❤️</span>
      ...
      <div class="location-icon">
        <svg viewBox="0 0 60 80" width="60" height="80" fill="none" stroke="#2d5a3d" stroke-width="2">
    ...
    <section class="section time-section">
      <div class="candles-icon">
        <svg viewBox="0 0 60 80" width="48" height="64" fill="none" stroke="#2d5a3d" stroke-width="1.5">
      ...
      <p class="script-heading">Завершение</p>
...
.candles-icon { margin-bottom: 4px; }
...
.wish-item .body-text { text-align: left; }
